#!/usr/bin/env bash
# DH Workshop — macOS setup script
set -euo pipefail
...
echo
echo "=============================================="
echo "  DH Workshop — macOS Setup"
echo "=============================================="

# ── 1. Git ────────────────────────────────────────────────────────────────────
step "Checking for Git"
if ! command -v git &>/dev/null; then
    yellow "Git not found. Launching Xcode Command Line Tools installer..."
    xcode-select --install 2>/dev/null || true
    echo
    red "Please complete the Xcode CLT installation, then re-run this script."
    exit 1
fi
